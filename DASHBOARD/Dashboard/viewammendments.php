...
// SQL query to select all amendments
$sql = "SELECT * FROM ammendments";
...
<head>
    ...
    <title>Ammendments - Admin Dashboard</title>
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>".$row["Policy_Member"]."</td>";
                            echo "<td>".$row["Beneficiary"]."</td>";
                            echo "<td>".$row["is_approved"]."</td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr><td colspan='6'>No amendments found</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
